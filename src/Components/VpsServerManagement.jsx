        ...
        <table class="compare-table" id="compare-table-i">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right-corner">--</td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/></td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">CXS license installed</span></td>
            </tr>
            ...
            <tr>
              ...
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/></td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">AlmaLinux</span></td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">AlmaLinux</span></td>
            </tr>
            ...
            <tr>
              ...
              <td class="right-corner">--</td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">Proactive response when issues are detected</span></td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">Proactive response when issues are detected</span></td>
            </tr>
            ...
            <tr>
              ...
              <td class="right-corner">--</td>
              <td class="right-corner">--</td>
              <td class="right-corner"><img src={checked} class="check-icon img-fluid" alt="Check"/><span class="d-text">Up to 200 GB weekly backup</span></td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default VpsServerManagement